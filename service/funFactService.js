...
//         // const group = getGradeGroup(parseInt(grade));
...
//         //     return cached.funFact;
//         // }

//         const funFact = await funFactRepository.getRandomFunFactByGroup(parseInt(age), grade);
//         if (!funFact) return null;

//         // cache[group] = {
//         //     funFact,
//         //     expiresAt: now + FUNFACT_CACHE_TTL,
//         // };
